        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="flex flex-col gap-2">
            <a href="/" className="block w-fit">
              {/* Ensure your final logo is named logo-footer.png in your public folder */}
              <img src="/logo-footer.png" alt="HelloVA Logo" className="h-16 w-auto object-contain rounded-xl" />
            </a>
            ...
            <div>
              ...
              <div className="flex items-center gap-5">
                ...
                <a href="https://facebook.com/hellova.solutions" target="_blank" rel="noreferrer" className="text-[#1877F2] hover:opacity-80 transition hover:scale-110">
                  <svg className="w-[30px] h-[30px]" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
                </a>
              </div>
            </div>
          </div>
